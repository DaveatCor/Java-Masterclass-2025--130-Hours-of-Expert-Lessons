...
public record Town(
    String name, String island, int level, List<Loot> loot, List<Feature> features, List<Combatant> opponents
) {
    ...
    public Town {
        ...
        if (level == 0){
            opponents.add(new Islander("Joe", Weapon.KNIFT));
        } else {
            opponents.add(new Islander("Joe", Weapon.ACHETE));
