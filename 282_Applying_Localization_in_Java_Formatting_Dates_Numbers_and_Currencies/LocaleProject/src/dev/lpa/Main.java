...
public class Main {
    public static void main(String[] args) {
        ...
        Locale enNZ = new Locale.Builder().setLanguage("en").setRegion("IN").build();
        ...
        DateTimeFormatter wdayMonth = DateTimeFormatter.ofPattern("EEEE, MMM 3, yyyy");
        LocalDate May5 = LocalDate.of(2020, 5, 5);

        System.out.println("----------------------");
        for (var locale : List.of(Locale.CANADA, Locale.CANADA_FRENCH, Locale.FRANCE, Locale.GERMANY, Locale.TAIWAN, Locale.JAPAN, Locale.ITALY)) {
            System.out.println(
            ...
            System.out.printf(locale, "\t%1$t, %1$tB %1$te, %1$tY %n", May5);
            ...
            NumberFormat decimalInfo2 = NumberFormat.getNumberInstance(Locale.ITALY);
            System.out.println("My Loan " + decimalInfo2.format(myLoan));
        }
    }
}