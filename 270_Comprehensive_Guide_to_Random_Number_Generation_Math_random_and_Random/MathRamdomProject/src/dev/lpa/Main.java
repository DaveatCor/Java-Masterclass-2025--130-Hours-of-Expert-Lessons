...
//            System.out.printf("Assigning id %d,d%n", id);
//        }
...
//        System.out.println(Math.absExact(Integer.MIN_VALUE));
        ...
        System.out.println("Min = " + Math.max(10.0000002, 10.001f));
        ...
        for (int i = 0; i < 10; i++){
            System.out.printf("%1$d = %1$c%n", (int) (Math.random() * 10) + 65);
        }
        ...
        System.out.println("--------------------------");
        for (int i = 0; i < 10; i++){
            System.out.printf("%1$d", r.nextInt(-10, 11));
        }
        ...
        Random noReallyRandom = new Random(nanoTime);
        System.out.println("\n--------------------------");
        pseudoRandom.ints(10, 0, 10)
                .forEach(i -> System.out.print(i + " "));
    }
