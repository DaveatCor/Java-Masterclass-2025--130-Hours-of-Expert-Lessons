...
public class MainCollect {
    public static void main(String[] args) {
        ...
        Set<Student> autstraliansStudents = students.stream()
                .filter((s) -> s.getCountryCode().equals("AU"))
                .collect(Collectors.toSet());
        System.out.println("# of Australian Students = " + autstraliansStudents.size());
        ...
        youngAussies1.addAll(autstraliansStudents);
        ...
        Set<Student> youngAussies2 = students.stream()
                ...
                .filter((s) -> s.getCountryCode().equals("AU"))
                .collect(() -> {
                    return new TreeSet<>(Comparator.comparing(Student::getStudentId));
