...
//        System.out.println(joe);
        ...
        System.out.println(joe);
        if (bank.doTransactions(joe.getCustomerId(), BankAccount.AccountType.CHECKING, 35)){
            System.out.println(joe);
        }

        if (bank.doTransactions(joe.getCustomerId(), BankAccount.AccountType.CHECKING, -535)){
            System.out.println(joe);
        }

        if (bank.doTransactions(joe.getCustomerId(), BankAccount.AccountType.CHECKING, -535.01)){
            System.out.println(joe);
        }
...
//        transactions.forEach((k, v) -> System.out.println(k + ": " + v));
        ...
        System.out.println("---------------------");
        joe.getAccount(BankAccount.AccountType.CHECKING).getTransactions().forEach((k, v) -> {
