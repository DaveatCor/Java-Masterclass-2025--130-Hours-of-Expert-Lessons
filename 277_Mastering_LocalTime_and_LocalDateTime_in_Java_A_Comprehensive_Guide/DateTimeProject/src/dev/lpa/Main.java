...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(May5.plus(356, ChronoUnit.DAYS));
        ...
        LocalTime sevenThirthy = LocalTime.of(7, 30, 15);
        System.out.println(sevenThirthy);

        LocalTime sevenPM = LocalTime.parse("19:00");
        LocalTime sevenThirthyPM = LocalTime.parse("19:35:15.1000");
        System.out.println(sevenPM.get((ChronoField.AMPM_OF_DAY)));
        System.out.println(sevenThirthyPM.get((ChronoField.AMPM_OF_DAY)));

        System.out.println(sevenThirthyPM.getHour());
        System.out.println(sevenThirthyPM.get(ChronoField.HOUR_OF_DAY));

        System.out.println(sevenThirthyPM.plus(1, ChronoUnit.HOURS));
        ...
        System.out.println(May5Noon.format(DateTimeFormatter.ofLocalizedDate(
            FormatStyle.MEDIUM
        )));

        LocalDateTime May6Noon = May5Noon.plusHours(24);
        System.out.println(May6Noon.format(DateTimeFormatter.ofLocalizedDate(
            FormatStyle.MEDIUM
        )));
