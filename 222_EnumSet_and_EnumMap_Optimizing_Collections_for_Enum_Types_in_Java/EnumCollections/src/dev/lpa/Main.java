...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        var annaDaysSet = EnumSet.copyOf(annsWorkDays);
        System.out.println(annaDaysSet.getClass().getSimpleName());
        ...
        Set<WeekDay> newPersonDays = EnumSet.complementOf(annaDaysSet);
        System.out.println("-----------------------");
        newPersonDays.forEach(System.out::println);

        Set<WeekDay> anotherWay = EnumSet.copyOf(allDaysSet);
        anotherWay.removeAll(annaDaysSet);
        System.out.println("-----------------------");
