...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("First of next Month = %tD %n" + firstOfMonth);
        ...
        for (ChronoUnit u : ChronoUnit.values()){
            if (u.isSupportedBy(LocalDate.EPOCH)){
                long value = u.between(LocalDate.EPOCH, dob2.toLocalDate());
                System.out.println(u + " past = " + value);
            } else {
