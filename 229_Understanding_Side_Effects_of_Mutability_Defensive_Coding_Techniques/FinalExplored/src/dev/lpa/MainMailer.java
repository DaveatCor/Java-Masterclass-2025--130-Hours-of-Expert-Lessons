...
public class MainMailer {
    public static void main(String[] args) {
        String[] names = {
            "Ann Jones", "Ann Jones Ph.D", "Bob Jones M.D.",
        ...
        System.out.println("There are " + counts.get(annJonesPhd) + " record for " + annJonesPhd);
        ...
        System.out.println("There are " + counts.get(annJonesPhd) + " records for " + annJones);
        System.out.println("-----------------");
