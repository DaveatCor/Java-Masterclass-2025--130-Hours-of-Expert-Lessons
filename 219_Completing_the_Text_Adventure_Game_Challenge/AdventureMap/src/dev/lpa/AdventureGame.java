...
public class AdventureGame {
    private static final String GAME_LOCATIONS = """
            ...
            forest,at the edget of a thick dark forest,S:road,E:lake
            lake,by an alpine lake surouned by wildflowers,W:forest,S:well house
            stream,near a stream with a rockey bed,W:valley, N:well house
            """;
    ...
    Map<String, Location> adventureMap = new HashMap<>();
