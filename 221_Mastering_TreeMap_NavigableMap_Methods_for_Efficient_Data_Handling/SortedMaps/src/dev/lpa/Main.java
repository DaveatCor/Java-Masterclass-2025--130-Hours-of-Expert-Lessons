...
//        var nextEntry = reversed.firstEntry();
        ...
        while (nextEntry != null) {
            ...
            System.out.println(firstDate + " purchase : " + lastDaysDate.size());

            LocalDate nextDate = reversed.higherKey(lastDate);
//            nextEntry = reversed.higherEntry(lastDate);
            nextEntry = reversed.pollFirstEntry(lastDate);
            firstDate = nextDate;
        }
        System.out.println("---------------------");
        datedPurchases.forEach((key, value) -> System.out.println(key + ": " + value));
    ...
    private static void displayStats(int period, Map<LocalDate, List<Purchase>> periousData){
        System.out.println("---------------------");
        Map<String, Integer> weeklyCounts = new TreeMap<>();
        periousData.forEach((key, value) -> {
