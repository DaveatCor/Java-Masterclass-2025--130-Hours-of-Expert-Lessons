...
public class Main {
    public static void main(String[] args) {
        ...
        Card.printDeck(cards, "Card Collection with Aces addes", 1);

        Collections.copy(cards, kingsOfClubs);
        Card.printDeck(cards, "Card Collection with Kings copies", 2);
        ...
        System.out.println("disjoint 2 = " + disjoint2);
        ...
        var sortBySuit = Comparator.comparing(Card::rank).thenComparing(Card::rank);
